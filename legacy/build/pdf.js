...
function getImageSmoothingEnabled(transform, interpolate) {
  ...
  var actualScale = Math.fround((globalThis.devicePixelRatio || 1) * _display_utils.PixelsPerInch.CSS / _display_utils.PixelsPerInch.PDF);
    ...
    value: function _processStreamMessage(data) {
      ...
      switch (data.stream) {
        ...
        case StreamKind.PULL:
          ...
          var onPull = this.streamSinks[streamId].onPull;
          new Promise(function (resolve) {
        ...
        case StreamKind.CANCEL:
          ...
          var onCancel = this.streamSinks[streamId].onCancel;
          new Promise(function (resolve) {
...
var pdfjsVersion = '2.11.241';
var pdfjsBuild = '064c21d36';
{
  if (_is_node.isNodeJS) {
